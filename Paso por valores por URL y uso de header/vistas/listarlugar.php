<?php
    ...
    if (!empty($lugaresLista)) {
        ...
        foreach ($lugaresLista as $lugarDatos) {
            ...
            echo '<td><form method="get" action="procesos.php"><input type="submit" name="modificarLugar" value="Modificar"></form></td>';
            echo '<td><form method="get" action="procesos.php"><input type="submit" name="borrarLugar" value="Borrar"></form></td>';
